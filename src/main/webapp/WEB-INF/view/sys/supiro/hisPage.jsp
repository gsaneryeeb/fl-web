...
<div class="panel panel-default div_screen">
			<form id="searchForm"
				action="${pageContext.request.contextPath}/sys/supiro/hisPage"
				method="get">
				...
				<div class="panel-heading">
					<table style="width: 100%;" id="searchTable">
						<tr>
							<td style="width: 25%;">供应商名称: <input name="search_LIKE_name"
...
<div id="initStaffsHis" class="panel panel-default div_screen">
	...
	<table style="width: 100%;" frame="below" bordercolorlight="#f5f5f5"
		...
		<tr bgcolor="#f5f5f5" height="35px">
			<td width="92%" style="padding-left: 10px">供应商列表
			</td>
			<td>
				<button id="_newBtn" class="btn btn-primary btn-sm" url="${pageContext.request.contextPath}/sys/supiro/new" modal="modal">
	...
	<table
		...
		<thead>
			<tr>
				<th class="table_screentitle">供应商名称</th>
				<th class="table_screentitle">联系人</th>
				<th class="table_screentitle">联系人电话</th>
		...
		<c:forEach items="${pageHis.content}" var="t">
			<tr align="center">
				<td><a name='_showBtn' href="javascript:void(0)" url="${pageContext.request.contextPath}/sys/supiro/${t.id}">${t.name}</a></td>
				<td>${t.contacts}</td>
				<td>${t.tel}</td>
				<td>${t.address}</td>
				<td>
				...
				<td><a name="_upBtn" href="javascript:void(0)" url="${pageContext.request.contextPath}/sys/supiro/edit/${t.id}">修改
				</a> || <a href="javascript:void(0)"
					onclick="del('${pageContext.request.contextPath}/sys/supiro/changeFlag?id=${t.id}&flag=${t.flag}')">
					<c:choose>
