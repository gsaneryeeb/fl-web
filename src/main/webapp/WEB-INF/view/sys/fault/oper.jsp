	...
	<div class="modal-dialog"
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">故障现象${_fuc }</h4>
			</div>
			<div class="modal-body">
				<div class="control-group panel panel-info">
					<div class="panel-heading" style="text-align: left;">故障现象基本信息</div>
					<form id="_operForm" action="${pageContext.request.contextPath}/sys/fault" method="${_method }">
						<input type="hidden" value="${t.id}" name="id">
						<table class="table	table-bordered table-condensed">
							<tbody>
								<tr>
									<td class="success" width="30%"><span class="glyphicon glyphicon-asterisk" style="color: RGB(194,31,8)"></span>故障现象名称:</td>
									<td align="left"><input name="name" value="${t.name}" class="input-control" size="40" id="_name"></td>
								</tr>
								<tr>
									<td class="success" width="30%">故障现象编号:</td>
