...
<div class="table-pagination row-fluid tool ui-toolbar">
    ...
    <ul class="pagination" style="float: left; ">
        <c:choose>
            ...
            <c:otherwise>
                <li><a href="javascript:goPageHis('${pageSize}', 1, '${accessPath}','${pageHis.totalPages }');" title="首页">首页</a></li>
                <li><a href="javascript:goPageHis('${pageSize}', ${current - 1}, '${accessPath}','${pageHis.totalPages }');" title="上一页">&lt;&lt;</a></li>
            </c:otherwise>
        </c:choose>

        <c:forEach begin="1" end="${begin == 1 ? 0 : 2}" var="i">
            <li <c:if test="${current == i}"> class="active"</c:if>>
                <a href="javascript:goPageHis('${pageSize}', ${i}, '${accessPath}','${pageHis.totalPages }');" title="第${i}页">${i}</a>
            </li>
        </c:forEach>
        ...
        <c:choose>
            ...
            <c:otherwise>
                <li><a href="javascript:goPageHis('${pageSize}', ${current + 1}, '${accessPath}','${pageHis.totalPages }');" title="下一页">&gt;&gt;</a></li>
                <li><a href="javascript:goPageHis('${pageSize}', ${pageHis.totalPages}, '${accessPath}','${pageHis.totalPages }');" title="尾页">尾页</a></li>
            </c:otherwise>
        </c:choose>
	    ...
	    <ul class="pagination" style="float: left;">
	    	<li>
		        ...
		        &nbsp; <select style="height: 19px;"  onchange="goPageHis($(this).val(), ${current}, '${accessPath}','${pageHis.totalPages }');">
